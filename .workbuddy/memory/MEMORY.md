...
- **评论系统**：Waline（serverURL: https://comment-waline.wqch.net/），服务端 v1.39.3，前端使用 @waline/client@v1 匹配，通过 layouts/partials/comments.html 集成，dark: 'html.dark' 自动跟随深浅色，含微博/bilibili 表情包，login: 'force' 强制登录，params.toml 开启 showComments = true
