...
- **评论系统**：Waline（serverURL: https://blog-comments-tau-red.vercel.app/），通过 layouts/partials/comments.html 集成，dark: 'html.dark' 自动跟随深浅色，含微博/bilibili 表情包，params.toml 开启 showComments = true
